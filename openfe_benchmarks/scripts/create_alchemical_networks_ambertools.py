...
def create_and_store_network(forcefield: str, ligand_network, solv, prot):
    ...
    alchemical_network_json_fp = basedir / f"{forcefield}_am1bcc_alchemical_network.json"
    json.dump(
...
def run_inputs(pdb):
    ...
    with open("ligand_network_am1bcc.graphml", mode='r') as f:
    ...
    for forcefield in ['openff-2.2.1']:
