...
206 unique solutes drawn from `subset_openff_filtered`. Selection seeded the 189 solutes present in both the FreeSolv and MNSol filtered pools (by OpenFF SMILES isomorphism), then added 17 further solutes during ChemicalEnvironment coverage fill targeting ≥3 representatives per checkmol environment. 189 of 206 selected solutes (91.7%) overlap with the MNSol filtered pool. 23 target ChemicalEnvironments do not reach ≥3 representatives in the subset: 16 are fully absent from the filtered pool (CarbonylHydrate, Aminal, Thioacetal, Cyanate, Isocyanate, AlkylFluoride, ArylFluoride, Thioaldehyde, Thioketone, Thiourea, Thiocyanate, Isothiocyanate, ThiocarboxylicAcid, ThiocarboxylicAcidEster, PhosphonicAcid, PhosphoricAcid); 7 are pool-limited with only 1–2 molecules available (Acetal, CarboxylicAcidSecondaryAmide, Disulfide, Hemiacetal, Hemiaminal, Sulfone, SulfonicAcidEster).